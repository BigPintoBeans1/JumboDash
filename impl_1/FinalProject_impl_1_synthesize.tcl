...
global para
set para(gui_mode) 1
set para(prj_dir) "Z:/New folder/JumboDash"
# synthesize IPs
# synthesize VMs
...
run_postsyn [list -a iCE40UP -p iCE40UP5K -t SG48 -sp High-Performance_1.2V -oc Industrial -top -w -o FinalProject_impl_1_syn.udb FinalProject_impl_1.vm] "Z:/New folder/JumboDash/impl_1/FinalProject_impl_1.ldc"
